...
public class Hotbar : MonoBehaviour, IInitialize
{
    ...
    {
        slot.ItemSet(item != null ? item.Sprite : null);
    }
    ...
    public void UseItem(PlayerInfo player)
    {
        ...
        {
            _initManager.GameActionManager.ItemActivate(_itemSlot[_currentSlotIndex], player);
